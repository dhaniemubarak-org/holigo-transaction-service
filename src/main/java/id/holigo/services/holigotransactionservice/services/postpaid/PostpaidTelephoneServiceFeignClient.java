...
@FeignClient(name = "holigo-postpaid-telephone-service")
public interface PostpaidTelephoneServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/postpaid/TLP/transactions/{id}";
