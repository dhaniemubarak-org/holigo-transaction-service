...
@FeignClient(name = "holigo-postpaid-pdam-service")
public interface PostpaidPdamServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/postpaid/PAM/transactions/{id}";
