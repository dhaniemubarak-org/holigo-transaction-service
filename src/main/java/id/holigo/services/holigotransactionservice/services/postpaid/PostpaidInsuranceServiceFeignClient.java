...
@FeignClient(name = "holigo-postpaid-insurance-service")
public interface PostpaidInsuranceServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/postpaid/INS/transactions/{id}";
