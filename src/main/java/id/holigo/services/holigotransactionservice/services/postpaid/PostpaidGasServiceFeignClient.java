...
@FeignClient(name = "holigo-postpaid-gas-service")
public interface PostpaidGasServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/postpaid/GAS/transactions/{id}";
