...
@FeignClient(name = "holigo-postpaid-multifinance-service")
public interface PostpaidMultifinanceServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/postpaid/MFN/transactions/{id}";
