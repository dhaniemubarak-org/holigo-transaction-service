...
@FeignClient(name = "holigo-postpaid-internet-service")
public interface PostpaidTvInternetServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/postpaid/NETV/transactions/{id}";
