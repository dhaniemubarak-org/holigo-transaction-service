...
@FeignClient(name = "holigo-prepaid-streaming-service")
public interface PrepaidStreamingServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/prepaid/STREAMING/transactions/{id}";
