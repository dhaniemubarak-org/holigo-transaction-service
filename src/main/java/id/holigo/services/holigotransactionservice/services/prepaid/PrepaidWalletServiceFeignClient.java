...
@FeignClient(name = "holigo-prepaid-ewallet-service")
public interface PrepaidWalletServiceFeignClient {

    static String DETAIL_TRANSACTION = "/api/v1/prepaid/WALLET/transactions/{id}";
